...
import { SidemenuItems } from "@/constants/menuItems"; // Adjust import if needed
...
// SideMenu Component
const SideMenu: React.FC<Props> = ({ ishidden = false, mode = "light" }) => {
  ...
  const updatedMenuItems = SidemenuItems(ishidden).map((item) => {
    return {
      ...item,
